# Walk-forward validation: NN model + risk-based position sizing
# Uses --prob-risk-pct 0.01 (1% of $1M = $10K risk per trade at max confidence)
...
Write-Host ""
Write-Host "============================================================"
Write-Host " WALK-FORWARD: NN + risk-based sizing (1% risk/trade)"
...
foreach ($fold in $folds) {
    ...
    $testYears = $fold.test
    $outFile = "$outDir\_wf_nn_risk_$label.txt"
    ...
    if ($foldNum -lt $totalFolds) {
        ...
        Write-Host " Est. remaining: $($remaining.ToString('hh\:mm\:ss'))"
    }
    Write-Host "------------------------------------------------------------"
    Write-Host ""
}
...
Write-Host ""
Write-Host "============================================================"
Write-Host " WALK-FORWARD COMPLETE (NN + risk-based sizing)"
Write-Host " Total time: $($totalTime.ToString('hh\:mm\:ss'))"
Write-Host "============================================================"
Write-Host ""
Write-Host "STOP SUMMARIES (all folds):"
Write-Host ""
