# filepath: c:\Users\Administrator\ibkr8\scripts\walk_forward_pnl.ps1
# Walk-forward validation for NN_PNL model (profit-maximising loss)
...
Write-Host ""
Write-Host "============================================================"
Write-Host " WALK-FORWARD: NN_PNL (profit-max loss) + setup_filter"
...
foreach ($fold in $folds) {
    ...
    $testYears = $fold.test
    $outFile = "$outDir\_wf_nn_pnl_$label.txt"
...
Write-Host ""
Write-Host "============================================================"
Write-Host " WALK-FORWARD COMPLETE (NN_PNL)"
